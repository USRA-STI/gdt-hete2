...
from gdt.missions.hete2 import __version__


# -- Project information -----------------------------------------------------

project = 'The Gamma-ray Data Tools: HETE-2'
license = 'Apache 2.0'
...
# -- PDF options -------------------------------------------------------------
latex_documents = [('index', 'hete2-gammaray-data-tools.tex', project, author, 'manual')]
